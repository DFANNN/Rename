...
你可以在 [Releases 页面](https://github.com/DFANNN/Rename/releases) 下载适用于你操作系统的最新版本，安装后即可使用：
...
特别感谢 **小薯条** 🍟 的设计灵感与 UI 点子，为本项目增添了不少美味的灵魂！<br>
